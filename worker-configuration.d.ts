/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df8afc2f022d9a79a06ccc7cadd451d4)
// Runtime types generated with workerd@1.20260426.1 2026-04-29 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker-shim");
		durableNamespaces: "CommentRoom";
	}
	interface Env {
		...
		AXIOM_LOGPUSH_VERGE_TOKEN: string;
		RESEND_API_KEY: string;
		COMMENTS: DurableObjectNamespace<import("./src/worker-shim").CommentRoom>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "AXIOM_LOGPUSH_VERGE_TOKEN" | "RESEND_API_KEY">> {}
}
